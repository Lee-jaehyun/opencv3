...
if __name__ == '__main__' :
    ...
    # 트레킹 함수 선택
    tracker_types = ['BOOSTING', 'MIL','KCF', 'TLD', 'MEDIANFLOW', 'GOTURN','CRST']
...
#    face_cascade = cv2.CascadeClassifier()
    face_cascade = cv2.CascadeClassifier("/Users/jaehyuni/Desktop/tensorflow_macos/arm64/opencv-4.5.0/data/haarcascades/haarcascade_frontalface_default.xml")
    #얼굴인식용 haar 불러오기
...
#            faces = face_cascade.detectMultiScale(grayframe, 1.1, 5)
...
### 출처 : https://m.blog.naver.com/PostView.naver?isHttpsRedirect=true&blogId=chandong83&logNo=221114779613
